...
##working directories 
```{r}
getwd()# by defualt you are in the directory you first opened
#setwd() 
```
## Load the tidyverse
...
```{r}
library("tidyverse")
#install.packages("package_name") command to install new package
```
...
```
```{r}
hbirds[1,3] #always goes row, column
