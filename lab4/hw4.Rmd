...
```{r}
ggplot(data=msleep, 
         mapping=aes(x= vore, , fill= vore))+
labs(title= "mammals in each vore type)")+
  geom_bar()+
...
```{r}
ggplot(data=msleep,
         mapping=aes(x= vore, y= bodywt, fill= vore))+
...
```{r}
ggplot(data=msleep,
         mapping=aes(x= sleep_total, y= bodywt, color = vore))+
labs(title= "body weight and total sleep time")+
  geom_point()+
 scale_y_log10()+
...
```{r}
ggplot(data=msleep,
         mapping=aes(y= sleep_total, x= vore, color = vore))+
labs(title= "species and total sleep time")+
  geom_boxplot()+
 scale_y_log10()+
scale_x_discrete(na.translate=F)
```
...
```{r}
ggplot(data=msleep,
         mapping=aes(y= bodywt, x= brainwt, color = vore))+
labs(title= "brain wieght vs. body weight")+
  geom_point()+
  scale_y_log10()+
scale_x_discrete(na.translate=F)
...
```{r}
ggplot(data=msleep,
         mapping=aes(y= brainwt, x= vore, color = vore))+
labs(title= "species and brain weight")+
  geom_boxplot()+
 scale_y_log10()+
scale_x_discrete(na.translate=F)
```
>>>>>>> 3dbe57cb48b461d04f8e76060bc0028cb934733b
## Knit and Upload
